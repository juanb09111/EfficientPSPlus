...
class Semantic_Depth(pl.LightningModule):
    """
    ...
    def __init__(self, cfg):
        ...
        self.learning_rate = cfg.SOLVER.BASE_LR_SEM_DEPTH
        self.cfg = cfg
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('IoU', self.valid_acc_sem, on_step=False, on_epoch=True)
        self.log('RMSE', self.valid_acc_depth, on_step=False, on_epoch=True)
    ...
    def configure_optimizers(self):
        print("Optimizer - using {} with lr {}".format(self.cfg.SOLVER.NAME, self.cfg.SOLVER.BASE_LR_SEM_DEPTH))
