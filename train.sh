...
#SBATCH --output=res/res_%a.txt
#SBATCH --error=res/err_%a.txt
#
#!/bin/bash
...
python -u train.py --model_name=EfficientPS_semantic --config=configs/effps.yml --nodes=1 --ngpus=4 --ip_adress $ip1
