...
def convert_single_core(proc_id, image_set, categories, source_folder, segmentations_folder, VOID=0):
    ...
    for working_idx, image_info in enumerate(image_set):
        ...
        file_path = os.path.join(segmentations_folder, file_name.split("/")[-1])

        file_name = os.path.join("/".join(segmentations_folder.split("/")[-3:]), file_name.split("/")[-1])
...
def convert(args):
    ...
    source_folder = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT)
    # images_json_file = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.TWO_CH_IMAGE_JSON_TRAIN)
    # segmentations_folder = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.COCO_PANOPTIC_SEGMENTATION_TRAIN)
    # predictions_json_file = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.COCO_PANOPTIC_ANNOTATION_TRAIN)
    # categories_json_file = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.COCO_ANNOTATION_TRAIN)

    images_json_file = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.TWO_CH_IMAGE_JSON_VAL)
    segmentations_folder = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.COCO_PANOPTIC_SEGMENTATION_VAL)
    predictions_json_file = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.COCO_PANOPTIC_ANNOTATION_VAL)
    categories_json_file = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.COCO_ANNOTATION_VAL)


    # if not os.path.isdir(segmentations_folder):
    #     src_folder = os.path.join("..", cfg.FOREST_DATASET.DATASET_PATH.ROOT, cfg.FOREST_DATASET.DATASET_PATH.RGB)
